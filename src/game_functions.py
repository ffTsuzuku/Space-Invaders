...
def check_events(game_settings, screen, stats, sb, play_button, ship, aliens, 
    ...
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            ...
            check_play_button(game_settings, screen, stats, sb, play_button, ship,
...
def update_screen(settings, screen, sb,  ship, bullets, alien, stats,
    play_button):
...
def update_bullets(game_settings, screen, stats, sb, ship, bullets, aliens):
    ...
    check_bullet_alien_collisions(game_settings, screen, stats, sb, ship, 
        aliens, bullets)

def check_bullet_alien_collisions(game_settings, screen, stats, sb, ship, 
    aliens, bullets):
    ...
    if len(aliens) == 0:
        ...
        #Increase the Level
        game_settings.level_up(stats) #increase difficulty
        sb.prep_level()
